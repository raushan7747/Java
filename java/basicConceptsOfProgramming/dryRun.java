 ...
 * whenever we needed just call them to repeat the same tasks, there may be need to calculate even most complex formulas, and we don't wanna to be repeat that complex formulas when we needed to do even more than a time. So, the another way is that, we just call our function to do that type of work as much better.
